...
public class ImageKitIoAPI implements ImageKitIoAPIInterface {
    ...
    public void upload(String dataPath, String fileName) {
        ...
        String urlEndpoint = "https://ik.imagekit.io/3kzmw02bl"; //endpoint
        String privateKey = "private_J0MWLVnE6SnhUqaqUYdvdbhIXIk=";
        String publicKey = "public_kfVDOMJwIunb51DdwarfFeNH/rQ=";
    ...
    public void download(String dataPath, String fileName) {
        String url = "https://ik.imagekit.io/3kzmw02bl/" + fileName + "?updatedAt=" + Instant.now().getEpochSecond(); //endpoint
